...
const fortuneMessages = {
  zodiac: {
    positive: [
      ...
      "성실하고 꾸준한 노력이 드디어 결실을 맺을 때입니다. 오랫동안 공들여온 일이 있다면 오늘 좋은 성과를 기대할 수 있으며, 당신의 노력을 인정받을 수 있는 날이 될 것입니다.",
      ...
      "당당한 리더십으로 모든 일이 순조롭게 풀릴 것 같습니다. 당신의 결정에 힘이 실리고 많은 사람들이 따르니, 그룹 프로젝트나 팀 활동에서 주도적인 역할을 맡아보시는 건 어떨까요?",
      "지혜롭고 신중한 판단력이 좋은 결과를 가져다줄 거예요. 복잡하게 얽힌 어려운 상황 속에서도 핵심을 꿰뚫어 보는 당신의 통찰력 덕분에 현명한 선택을 내릴 수 있을 것입니다.",
    ],
    caution: [
      "섣부른 판단보다는 신중함이 필요한 시기입니다. 모든 정보가 당신에게 주어진 것이 아닐 수 있으니, 중요한 결정을 내리기 전에 한 번 더 확인하고 주변의 조언을 구하세요.",
      "자신의 생각만 고집하기보다는 유연한 사고가 도움이 될 것입니다. 다른 사람의 의견에도 귀를 기울일 때, 당신이 미처 생각하지 못했던 더 나은 해결책을 발견할 수 있습니다.",
      "성급하게 서두르기보다는 차근차근 계획을 세워보세요. 마음이 급할수록 실수가 잦아질 수 있습니다. 잠시 숨을 고르고 주변을 둘러보며 전체적인 과정을 검토하는 시간이 필요합니다.",
      "오늘은 평소보다 소심해질 수 있지만, 이럴 때일수록 자신감을 가져보세요. 위축되지 않고 당당하게 의견을 표현하면 주변 사람들도 당신을 신뢰할 확률이 높아지게 될 것입니다.",
      "때로는 자존심을 내려놓는 것이 더 큰 힘이 될 수 있습니다. 사소한 일로 논쟁하고 다투기 보다는 가끔은 한발 물러서서 상황을 넓게 보세요. 그것이 관계를 지키는 지혜입니다.",
      "근거 없는 의심은 좋은 기회를 멀어지게 할 수 있습니다. 상대방의 의도를 긍정적으로 바라보고 그에 대한 믿음을 보여주세요. 신뢰가 바탕이 될 때 더 큰 가능성이 열립니다.",
    ],
  },
  constellation: {
    positive: [
      "창의적인 아이디어가 샘솟고, 예술적인 감각이 빛을 발할 때입니다. 당신의 독창적이고 창의적인 생각이 주변에 신선한 영감을 주고, 새로운 무언가의 시작으로 이어질 수 있습니다.",
      "감성이 풍부한 당신의 매력이 돋보이는 하루가 될 거예요. 주변 사람들과의 교류 속에서 예기치 못하게 당신의 따뜻한 마음이 전달되어, 예상치 못한 운명의 인연을 만나게 될 수 있습니다.",
      "활동적인 에너지가 넘쳐 새로운 시작을 하기에 완벽한 날입니다. 미뤄왔던 운동이나 학습 계획이 있다면 오늘부터 시작해보세요. 활기찬 에너지가 당신을 목표로 이끌어줄 것입니다.",
      "안정적인 기반 위에서 한 단계 더 성장할 수 있는 기회가 찾아옵니다. 재정적으로나 관계적으로나 안정감을 느끼게 될 것이며, 이를 바탕으로 더 큰 꿈을 계획할 수 있게 될 것입니다.",
      "뛰어난 소통 능력을 발휘하여 주변 사람들과의 관계를 더욱 돈독히 할 수 있습니다. 그러한 능력이 당신의 말에 설득력이 더해지니, 중요한 협상이나 발표에서 좋은 결과를 얻을 수 있습니다.",
      "따뜻한 마음으로 주변 사람들을 챙기고 배려하는 모습이 당신을 더욱 빛나게 합니다. 당신의 친절함과 배려가 결국 당신에게 더 크고 좋은 행운으로 돌아오는 선순환을 만들게 될 것입니다.",
    ],
    caution: [
      "예상치 못한 변화의 바람이 불어올 수 있지만, 두려워하지 말고 적응해보세요. 변화의 흐름에 흔들리지 않고 유연하게 대처한다면, 이는 오히려 새로운 성장의 기회가 될 수 있습니다.",
      "감정적인 결정보다는 이성적이고 논리적인 판단이 필요한 하루입니다. 중요한 사안일수록 개인적인 감정을 최대한 억누르고 객관적인 데이터를 바탕으로 신중하게 결정해보시길 바랍니다.",
      "의욕이 앞서 무모한 도전을 하기보다는, 신중한 계획을 세우는 것이 중요합니다. 당신의 열정은 소중하지만, 현실적인 계획이 뒷받침될 때 비로소 빛을 발할 수 있습니다.",
      "자신만의 방식을 고집하기보다는, 주변의 조언에 귀 기울이고 열린 마음을 가져보시길 바랍니다. 당신이 보지 못하는 부분을 다른 사람이 발견해주고, 더 나은 길로 이끌어줄 수 있습니다.",
      "여러 가지 일에 관심이 흩어져 집중력을 잃기 쉬운 날입니다. 가장 중요한 일의 우선순위를 정하고, 한 번에 하나씩 차분하게 처리해 나가는 지혜가 필요한 하루입니다.",
      "아직 일어나지 않은 일에 대한 과도한 걱정은 내려놓으세요. 걱정과 근심보다는 긍정적인 마음가짐으로 현재에 집중할 때, 문제 해결의 실마리를 더 쉽게 찾을 수 있을 것입니다.",
    ],
  },
}
